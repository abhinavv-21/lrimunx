...
/**
 * Tokens mirror DESIGN.md exactly. Feature code uses these names only —
 * arbitrary values like text-[#ff0000] or p-[13px] are not permitted.
 */
export default {
    ...
    extend: {
      colors: {
        ...
        accent: {
          ...
          pressed: '#7C0F5A',
          wash: '#FDF2F9',
          // Lighter magenta for use on the inverted plum surface, where the
          // base accent only reaches 2.9:1.
          bright: '#E24BA8',
        },
      ...
      spacing: {
        // 4px base unit — the permitted steps from DESIGN.md.
        row: '52px',
        'row-mobile': '56px',
        tap: '48px',
        rail: '64px',
