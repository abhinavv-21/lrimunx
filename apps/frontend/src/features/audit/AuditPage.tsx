...
import { Eraser, FileClock, Search } from 'lucide-react'
    ...
    <>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:max-w-2xl">
          ...
          {({ id }) => (
            <div className="relative">
              ...
              <Input
                ...
                placeholder="Person, action or record type"
                className="pl-9"
              />
            </div>
          )}
        ...
        <Field label="Record type">
          {({ id }) => (
            <Select id={id} value={entityType} onChange={(event) => setEntityType(event.target.value)}>
              <option value="">All records</option>
              <option value="Delegate">Delegate</option>
              <option value="Committee">Committee</option>
              <option value="Assignment">Assignment</option>
              <option value="LogisticsReq">Logistics request</option>
