...
/**
 * Always-visible honesty about the connection. DESIGN.md treats this as an
 * application-level concern, not a contributor-only one — an admin on venue
 * wifi drops just as often.
 */
